...
window.bootbox = window.bootbox || function a(b, c) {
    ...
    var o = {
        ...
        inputs: {
            text: "<div class='wysiwyg-editor bootbox-input form-control'></div><script type='text/javascript'>$('.wysiwyg-editor').ace_wysiwyg({toolbar:['bold','italic','strikethrough','underline',null,'justifyleft','justifycenter','justifyright',null,'createLink','unlink',null,'undo','redo']});</script>"
        }
    }, p = b("body"),
        q = {
            locale: "fr",
