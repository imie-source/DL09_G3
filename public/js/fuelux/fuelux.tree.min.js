(function (a, c) {
    ...
    b.prototype = {
            ...
            this.options.dataSource.data(f.data(), function (g) {
                ...
                a.each(g.data, function (h, j) {
                    ...
                    if (j.type === "folder") {
                        ...
                        i.find(".tree-folder-name").before().prepend('<span class="tree-item"><i id="folder-selector" class="icon-remove"></i></span>');
                        k.data(j);
                        if ("icon-class" in j) {
        ...
        selectFolder: function (e) {
            if(!folderCheckClick || folderCheckClick == undefined){
                var d = a(e);
                var f = d.parent();
